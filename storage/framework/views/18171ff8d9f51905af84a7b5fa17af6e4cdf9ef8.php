        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <?php echo e(trans('global.create')); ?> <?php echo e(trans('cruds.tax.title_singular')); ?>
                ...
                <div class="panel-body">
                    <form method="POST" action="<?php echo e(route("admin.taxes.store")); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group <?php echo e($errors->has('tax_name') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control" type="text" name="tax_name" id="tax_name" value="<?php echo e(old('tax_name', '')); ?>" required>
                        ...
                        <div class="form-group <?php echo e($errors->has('tax_percentage') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control" type="number" name="tax_percentage" id="tax_percentage" value="<?php echo e(old('tax_percentage', '')); ?>" step="0.01">
                        ...
                        <div class="form-group <?php echo e($errors->has('countries') ? 'has-error' : ''); ?>">
                            ...
                            <select class="form-control select2" name="countries[]" id="countries" multiple>
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($id); ?>" <?php echo e(in_array($id, old('countries', [])) ? 'selected' : ''); ?>><?php echo e($country); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sl_projects\dev-sl-admin-3133b5cfd61dd554 (3)\resources\views/admin/taxes/create.blade.php ENDPATH**/ ?>