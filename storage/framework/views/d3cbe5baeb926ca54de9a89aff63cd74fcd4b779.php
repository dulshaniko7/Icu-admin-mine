                ...
                <div class="panel-body">
                    <form method="POST" action="<?php echo e(route("admin.products.store")); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group <?php echo e($errors->has('product_name') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control" type="text" name="product_name" id="product_name" value="<?php echo e(old('product_name', '')); ?>" required>
                        ...
                        <div class="form-group <?php echo e($errors->has('product_code') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control" type="text" name="product_code" id="product_code" value="<?php echo e(old('product_code', '')); ?>" required>
                        ...
                        <div class="form-group <?php echo e($errors->has('product_price') ? 'has-error' : ''); ?>">
                            ...
                            <input class="form-control" type="number" name="product_price" id="product_price" value="<?php echo e(old('product_price', '')); ?>" step="0.01">
                        ...
                        <div class="form-group <?php echo e($errors->has('status') ? 'has-error' : ''); ?>">
                            ...
                            <?php $__currentLoopData = App\Product::STATUS_RADIO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div>
                                    <input type="radio" id="status_<?php echo e($key); ?>" name="status" value="<?php echo e($key); ?>" <?php echo e(old('status', '') === (string) $key ? 'checked' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sl_projects\dev-sl-admin-3133b5cfd61dd554 (3)\resources\views/admin/products/create.blade.php ENDPATH**/ ?>