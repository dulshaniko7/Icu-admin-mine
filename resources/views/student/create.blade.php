                    ...
                    <div class="panel-body">
                        <form method="POST" action="{{ route("students.store") }}" >
                            ...
                            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                <label class="required"  for="last_name">Email</label>
                            ...
                            <div class="form-group {{ $errors->has('school_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" name="school_name" id="school_name" value="{{ old('school_name', '') }}" required>
                                @if($errors->has('school_name'))
                                    <span class="help-block" role="alert">{{ $errors->first('school_name') }}</span>
                                @endif
